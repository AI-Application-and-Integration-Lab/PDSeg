...
def train_distill_on_patch(path_work, model, dataloader_train, device, hp, valid_fn=None, dataloader_valid=None, test_num_pos=0, args=None):
                ...
                if not args.weakly: # 如果不是弱監督的話
                    ...
                    if args.cnn_distill:
                        ...
                        if epoch >= 1: # distillation
                            ...
                            lossf += F.binary_cross_entropy_with_logits(x_enc, pseudo_gt_seg_lx)
