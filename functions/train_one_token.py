...
def train_one_token(path_work, model, dataloader_train, device, hp, valid_fn=None, dataloader_valid=None, test_num_pos=0, args=None):
        ...
        for index, batch in enumerate(dataloader_train):
            ...
            if args.model == 'segmenter':
                ...
                if args.mid_decode:
                    ...
                    # print("@@@@", mid_masks)
                    # print(output['one_cls_token'].shape)
                ...
                if not args.weakly: # 如果不是弱監督的話
                    ...
                    losst = loss_fn(torch.sigmoid(distill_token).squeeze(1), label)
                    # if args.cnn_distill:
